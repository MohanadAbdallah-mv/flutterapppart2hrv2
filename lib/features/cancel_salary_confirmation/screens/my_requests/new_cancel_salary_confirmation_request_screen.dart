...
class _NewCancelSalaryConfirmationRequestScreenState extends State<NewCancelSalaryConfirmationRequestScreen> {
  ...
  void _submitForm() async {
    ...
    final bool success = await hrProvider.createCancelSalaryConfirmationRequest( // ---== تم التعديل ==---
    ...
    if (mounted) {
      if (success) {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(l10n.cancelSalaryConfirmationRequestSentSuccessfully), backgroundColor: Colors.green)); // ---== تم التعديل ==---
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(l10n.newCancelSalaryConfirmationRequest), // ---== تم التعديل ==---
