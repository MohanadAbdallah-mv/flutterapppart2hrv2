...
class MyCarMovementRequestCard extends StatelessWidget {
  ...
  const MyCarMovementRequestCard({super.key, required this.request, required this.onTap});
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildInfoRow(Icons.directions_car_filled_outlined, l10n.carNoLabel, request.carNo ?? '...'),
              ...
              _buildInfoRow(Icons.calendar_today_outlined, l10n.carMovementDateLabel, _formatDate(request.prmDate, locale)),
              _buildInfoRow(Icons.access_time_outlined, l10n.carMovementTimeLabel, '${_formatTime(request.fromTime, locale)} - ${_formatTime(request.toTime, locale)}'),
              // ---== نهاية التعديل ==---
